...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("Cannot reverse this migration. 'Testimonial.published_work' and its values cannot be restored.")
    ...
    models = {
        ...
        'base.testimonial': {
            ...
            'published_work': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'published_work_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
