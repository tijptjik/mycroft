...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Testimonial.published_work_url'
        db.alter_column('base_testimonial', 'published_work_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Testimonial.published_work'
        db.alter_column('base_testimonial', 'published_work', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

    def backwards(self, orm):

        # Changing field 'Testimonial.published_work_url'
        db.alter_column('base_testimonial', 'published_work_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Testimonial.published_work'
        db.alter_column('base_testimonial', 'published_work', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
