...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Preview.vimeo_id' to 'Preview.youtube_id'
        db.rename_column('base_preview', 'vimeo_id', 'youtube_id')      

    def backwards(self, orm):
        db.rename_column('base_preview', 'youtube_id', 'vimeo_id')
    ...
    models = {
        ...
        'base.access': {
            ...
            'activation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 0, 0)'}),
        ...
        'base.preview': {
            ...
            'youtube_id': ('django.db.models.fields.CharField', [], {'max_length': '11'})
        },
        'base.product': {
