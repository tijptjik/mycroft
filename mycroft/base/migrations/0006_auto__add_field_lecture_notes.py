...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lecture.notes'
        db.add_column('base_lecture', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lecture.notes'
        db.delete_column('base_lecture', 'notes')
    ...
    models = {
        ...
        'base.access': {
            ...
            'activation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 0, 0)'}),
