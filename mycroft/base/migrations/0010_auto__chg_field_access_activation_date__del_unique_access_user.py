...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Access', fields ['user']
        db.delete_unique('base_access', ['user_id'])


        # Changing field 'Access.activation_date'
        db.alter_column('base_access', 'activation_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Access.activation_date'
        db.alter_column('base_access', 'activation_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding unique constraint on 'Access', fields ['user']
        db.create_unique('base_access', ['user_id'])
    ...
    models = {
        ...
        'base.access': {
            ...
            'activation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 30, 0, 0)'}),
