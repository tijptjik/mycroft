...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Preview.video'
        db.delete_column('base_preview', 'video')

        # Adding field 'Preview.vimeo_id'
        db.add_column('base_preview', 'vimeo_id',
                      self.gf('django.db.models.fields.URLField')(default=0, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Preview.video'
        db.add_column('base_preview', 'video',
                      self.gf('django.db.models.fields.URLField')(default='http://vimeo.com', max_length=200),
                      keep_default=False)

        # Deleting field 'Preview.vimeo_id'
        db.delete_column('base_preview', 'vimeo_id')
    ...
    models = {
        ...
        'base.preview': {
            ...
            'vimeo_id': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        'base.product': {
